...
Device Policy page component should be displayed
    Navigate to Module    ${MODULE_DEVICE_GROUP_POLICY}
...
Device Policy - Details - details page should be correct
    Navigate to Module    ${MODULE_DEVICE_GROUP_POLICY}
    Input Device Group    ro-dg-dont-delete       
    Click Search
    Wait Until Element Is Not Visible    ${progress_bar}
    Click Searched Device Policy    ro-dg-dont-delete
    Verify Device Policy Details Page Component

Device Policy - Details - device policy details page should be redirected to device policy list page when List button is clicked
    Navigate to Module    ${MODULE_DEVICE_GROUP_POLICY}
    Input Device Group    ro-dg-dont-delete       
    Click Search
    Wait Until Element Is Not Visible    ${progress_bar}
