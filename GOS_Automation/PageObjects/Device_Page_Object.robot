...
${device_name_result_table}             //tr[count]/td[@data-testid='table-body-cell'][1]/text()[contains(translate(., 'UPPER', 'lower'), 'value')]
${device_first_result_table}            //tr[1]/td[@data-testid='table-body-cell'][1][contains(text(),'value')]
${device_group_first_result_table}      //tr[1]/td[@data-testid='table-body-cell'][1][contains(text(),'value')]
${product_name_result_table}            //tr[count]/td[@data-testid='table-body-cell'][2]/text()[contains(translate(., 'UPPER', 'lower'), 'value')]
${device_group_name_result_table}       //tr[count]/td[@data-testid='table-body-cell'][3]/text()[contains(translate(., 'UPPER', 'lower'), 'value')]
${device_model_name_result_table}       //tr[count]/td[@data-testid='table-body-cell'][4]/text()[contains(translate(., 'UPPER', 'lower'), 'value')]

${label_device}                         //h1[text()='Device / Device Manager']
${search_field_dropdown}                //div[@class='tw-flex tw-flex-auto tw-max-w-full']/span[text() = 'Device Name']
