...
Search Product using search field
...
Click Searched Product
    [Arguments]    ${product_name}
            Wait and Click Element    ${product_first_result_table.replace("value","${product_name}")}


Verify Product Manager Details Page Component
    Wait Until Element Is Visible     ${details_title.replace('title', 'Product Manager')}
    Wait Until Element Is Visible     ${details_label.replace('field_label', 'Product Name')}
